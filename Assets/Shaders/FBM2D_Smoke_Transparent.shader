Shader "Custom/LKG_FBM2D_Smoke_Transparent"
{
    Properties
    {
        ...
        _NoiseZOffset ("Noise Z Offset",   Float) = 0.0
        ...
        _CenterVignetteStart ("Center Vignette Start", Float) = 0.5
        _CenterVignetteEnd ("Center Vignette End", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "LKG_FBM2D_Smoke_Transparent"
            ...
            float _CenterVignetteStart;
            float _CenterVignetteEnd;
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                float cDist = 1.0 - smoothstep(_CenterVignetteStart, _CenterVignetteEnd, length(uv - float2(0.5, 0.5)));
                ...
                float alpha = smoothstep(_NoiseAStart, _NoiseAEnd, v);
                ...
                //finalCol = float3(cDist, cDist, cDist);
                //alpha = 1.0;
                half4 fragCol = half4(finalCol, alpha);
