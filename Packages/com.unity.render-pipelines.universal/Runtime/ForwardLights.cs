    ...
    public class ForwardLights
    {
        ...
        internal void PreSetup(UniversalRenderingData renderingData, UniversalCameraData cameraData, UniversalLightData lightData)
        {
            if (m_UseForwardPlus)
            {
                ...
                var worldToViews = new Fixed2<float4x4>(cameraData.GetViewMatrix(), cameraData.GetViewMatrix());
                var viewToClips = new Fixed2<float4x4>(cameraData.GetProjectionMatrix(), cameraData.GetProjectionMatrix());
