...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
...
#endif
        CopyDepthPass m_LKGCopyDepthPass;
#if UNITY_EDITOR
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            // lkg edit
            SinglepassKeywords.UNITY_STEREO_INSTANCING_ENABLED = GlobalKeyword.Create("UNITY_STEREO_INSTANCING_ENABLED");
            SinglepassKeywords.USE_CAMERA_DEPTH = GlobalKeyword.Create("USE_CAMERA_DEPTH");
            ...
            m_LKGCopyDepthPass = new CopyDepthPass(RenderPassEvent.AfterRendering + k_AfterFinalBlitPassQueueOffset, copyDephPS);
