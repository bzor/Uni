...
#define glstate_matrix_projection     unity_StereoMatrixP_lkg[unity_StereoEyeIndex] // goes through GL.GetGPUProjectionMatrix()
#define unity_MatrixV                 unity_StereoMatrixV_lkg[unity_StereoEyeIndex]
#define unity_MatrixInvV              unity_StereoMatrixInvV_lkg[unity_StereoEyeIndex]
#define unity_MatrixInvP              unity_StereoMatrixInvP_lkg[unity_StereoEyeIndex]
#define unity_MatrixVP                unity_StereoMatrixVP_lkg[unity_StereoEyeIndex]
#define unity_MatrixInvVP             unity_StereoMatrixInvVP_lkg[unity_StereoEyeIndex]

// Camera transform (but the same as pass transform for XR).
#define unity_CameraProjection        unity_StereoCameraProjection_lkg[unity_StereoEyeIndex] // Does not go through GL.GetGPUProjectionMatrix()
#define unity_CameraInvProjection     unity_StereoCameraInvProjection_lkg[unity_StereoEyeIndex]
#define unity_WorldToCamera           unity_StereoMatrixV_lkg[unity_StereoEyeIndex] // Should be unity_StereoWorldToCamera but no use-case in XR pass
#define unity_CameraToWorld           unity_StereoMatrixInvV_lkg[unity_StereoEyeIndex] // Should be unity_StereoCameraToWorld but no use-case in XR pass
#define _WorldSpaceCameraPos          unity_StereoWorldSpaceCameraPos_lkg[unity_StereoEyeIndex]
#endif
...
float4x4 unity_StereoMatrixP_lkg[LKG_VIEWCOUNT];
float4x4 unity_StereoMatrixInvP_lkg[LKG_VIEWCOUNT];
float4x4 unity_StereoMatrixV_lkg[LKG_VIEWCOUNT];
float4x4 unity_StereoMatrixInvV_lkg[LKG_VIEWCOUNT];
float4x4 unity_StereoMatrixVP_lkg[LKG_VIEWCOUNT];
float4x4 unity_StereoMatrixInvVP_lkg[LKG_VIEWCOUNT];

float4x4 unity_StereoCameraProjection_lkg[LKG_VIEWCOUNT];
float4x4 unity_StereoCameraInvProjection_lkg[LKG_VIEWCOUNT];

float3   unity_StereoWorldSpaceCameraPos_lkg[LKG_VIEWCOUNT];
CBUFFER_END
#endif
...
#if defined(USING_STEREO_MATRICES)
float4x4 _PrevViewProjMatrixStereo[LKG_VIEWCOUNT];
float4x4 _NonJitteredViewProjMatrixStereo[LKG_VIEWCOUNT];
float4x4 _ViewProjMatrixStereo[LKG_VIEWCOUNT];
