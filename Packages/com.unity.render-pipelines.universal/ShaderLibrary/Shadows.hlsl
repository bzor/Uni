...
half SampleScreenSpaceShadowmap(float4 shadowCoord)
{
    ...
    // lkg edit
    // todo: go from center view or something
    ...
    half attenuation = SAMPLE_TEXTURE2D_ARRAY(_ScreenSpaceShadowmapTexture, sampler_PointClamp, shadowCoord.xy, 0).x;
    // half attenuation = SAMPLE_TEXTURE2D_ARRAY(_ScreenSpaceShadowmapTexture, sampler_PointClamp, shadowCoord.xy, LKG_VIEWCOUNT / 2).x;
#else
